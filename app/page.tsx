...
export default function Home() {
  ...
  return (
    <main style={{minHeight:'100vh', backgroundColor:'#ffffff', fontFamily:'system-ui, sans-serif'}}>
      ...
      {/* Hero */}
      <section style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', textAlign:'center', padding:'120px 48px', maxWidth:'900px', margin:'0 auto'}}>
        ...
        <h1 style={{fontSize:'64px', fontWeight:'500', letterSpacing:'-2px', color:'#111', lineHeight:'1.0', marginBottom:'24px'}}>
      ...
      {/* Features */}
      <section style={{padding:'80px 48px', borderTop:'1px solid #f0f0f0'}}>
        <div style={{maxWidth:'900px', margin:'0 auto', display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:'48px'}}>
      ...
      {/* Footer */}
      <footer style={{padding:'32px 48px', borderTop:'1px solid #f0f0f0', display:'flex', alignItems:'center', justifyContent:'space-between'}}>
        <div style={{display:'flex', alignItems:'baseline', gap:'2px'}}>
